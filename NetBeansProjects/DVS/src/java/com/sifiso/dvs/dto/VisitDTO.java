...
public class VisitDTO implements Serializable {
    ...
    public VisitDTO(Visit a) {
        this.visitID = a.getVisitID();
        dateMade = a.getDateMade().getTime();
        flag = a.getFlag();
        visitedDate = a.getVisitedDate().getTime();
        paymentType = a.getPaymentType();
        doctorID = a.getDoctor().getDoctorID();
        patientfileID = a.getPatientfile().getPatientFileID();
        receptionistID = a.getReceptionist().getReceptionistID();
        doctor = new DoctorDTO(a.getDoctor());
        patientfile = new PatientfileDTO(a.getPatientfile());
        receptionist = new ReceptionistDTO(a.getReceptionist());
