...
import com.sifiso.dvs.util.DataException;
...
public class CrashReportServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            platformUtil.addServerError(319, "Unable to add Android Error", "CrashReportServlet");
        }
    }
    @EJB
    DataUtil dataUtil;
    ...
    private void getErrorData(HttpServletRequest request) throws DataException {
        ...
        try {
            if (custom != null || !custom.trim().isEmpty()) {
                ...
                Doctor gg = dataUtil.getDoctorByID(Integer.parseInt(id));
                e.setDoctor(gg);
            }
        } catch (Exception ex) {
