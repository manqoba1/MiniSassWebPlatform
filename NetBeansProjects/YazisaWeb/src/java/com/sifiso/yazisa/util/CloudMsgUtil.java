...
public class CloudMsgUtil {
    ...
    public static final String API_KEY = "AIzaSyDRA6osnvK4Cu2X-fb1rEXbGPEpNTzUuzo";

    public ResponseDTO sendTeacherToParentMessage(IssueDTO req, PlatformUtil platformUtil, DataUtil dataUtil) throws
