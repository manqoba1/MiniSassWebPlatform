...
public class CloudMessagingRegistrar {
    ...
    public static ResponseDTO sendRegistration(String regID, 
        ...
        if (error != null && !error.equalsIgnoreCase("")) {
            ...
            platformUtil.addServerError(909, sb.toString(), "Cloud Messaging Service");
        } else {
            // we have SUCCESS!!
            ...
            platformUtil.addServerError(0, sb.toString(), "Cloud Messaging Service");
            return resp;
        }
    ...
    private static final String API_KEY = "AIzaSyDRA6osnvK4Cu2X-fb1rEXbGPEpNTzUuzo";
}
